...
function mClassChangeCss() {
    //모바일
    $(".m-swiper-pagination").show();
    // $(".kakao-item").removeClass("mg-top-10");
...
function tClassChangeCss() {
    ...
    // if (!$(".kakao-item").hasClass("mg-top-10")) {
    //     $(".kakao-item").addClass("mg-top-10");
    // };
